    ...
    <div class="review-container">
      ...
      <div class="review-content">
          ...
          <div class="review-card">
              <div class="image">
              	<input type="hidden" class="reviewPostNo" value="${reviewVO.postNo}">
				<a href="/board/review/get?currPage=${pageMaker.cri.currPage}&postNo=${reviewVO.postNo}"
              ...
              <div class="profile">
                  <img src="../../resources/img/profile.jpg" alt="">
                  <span class="nickName">${reviewVO.nickName}</span>
              </div>
          </div>
		</c:forEach>
