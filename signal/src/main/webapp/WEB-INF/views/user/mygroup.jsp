...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/transfer.css">
						...
						<c:forEach var="group" items="${__GROUP__}">
							<c:if test="${group.outCome == '진행중' || group.outCome == '수락'}">
								...
								<c:if test="${group.outCome == '진행중'}">
									<div class="result">
										<button class="accept-button" type="button" name="outCome"
											value="수락">수락</button>
										<button class="reject-button" type="button" name="outCome"
											value="거절">거절</button>
									</div>
								</c:if>
								...
								<c:if test="${group.outCome == '거절'}">
									<div class="result">거절</div>
								</c:if>
